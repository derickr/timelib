...
TEST_CREATE_TS_FROM_STRINGS(issue0172, -62163000000, "@-62163000000", "now", "UTC")

TEST_CREATE_TS_FROM_STRINGS(long_min_0, -9223372036854775808, "@-9223372036854775808", "now", "UTC");
TEST_CREATE_TS_FROM_STRINGS(long_min_1, -9223372036854775000, "@-9223372036854775000", "now", "UTC");

TEST_CREATE_TS_FROM_STRINGS(long_max_0, 9223372036854775807, "@9223372036854775807", "now", "UTC");
TEST_CREATE_TS_FROM_STRINGS(long_max_1, 9223372036854775000, "@9223372036854775000", "now", "UTC");
