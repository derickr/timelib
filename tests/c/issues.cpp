...
TEST(issues, tzcorparse_01)
{
	...
	timelib_parse_zone((char**) &str, &dst, &t, &tz_not_found, timelib_builtin_db(), timelib_parse_tzfile);
...
TEST(issues, tzcorparse_02)
{
	...
	ret = timelib_parse_zone((char**) &str, &dst, &t, &tz_not_found, timelib_builtin_db(), timelib_parse_tzfile);
