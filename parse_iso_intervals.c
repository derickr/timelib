/* Generated by re2c 0.13.5 on Mon Jul 20 15:00:28 2015 */
...
std:
	s->tok = cursor;
	s->len = 0;
#line 276 "parse_iso_intervals.re"
...
yy7:
	++YYCURSOR;
#line 378 "parse_iso_intervals.re"
	{
		goto std;
	}
#line 390 "<stdout>"
yy9:
	++YYCURSOR;
#line 383 "parse_iso_intervals.re"
	{
		s->pos = cursor; s->line++;
		goto std;
	}
...
yy51:
	...
	if (yych >= ':') goto yy13;
	++YYCURSOR;
#line 358 "parse_iso_intervals.re"
	{
...
yy83:
	++YYCURSOR;
#line 292 "parse_iso_intervals.re"
	{
...
yy98:
	...
	if (yych <= '9') goto yy98;
yy100:
#line 281 "parse_iso_intervals.re"
	{
